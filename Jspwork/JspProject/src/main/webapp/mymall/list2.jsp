...
<%
   ...
   for(int i=0;i<list.size();i++)
   {
      ...
      <td align="center"><img src='<%=dto.getPhoto() %>' width="60px" height="60px" class="img-thumbnail"></td>
      ...
      <td align="center" valign="middle">
         ...
         onclick="location.href='updateForm.jsp?num=<%=dto.getNo()%>'">수정</button>
         <button type="button" class="btn btn-danger btn-sm" 
         onclick="del(<%=dto.getNo() %>)">삭제</button></td>
      </tr>
   <%}
