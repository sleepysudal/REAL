...
<body>		
	...
	<!-- hidden은 위치 상관 없고 폼 안에만 있으면 됨 -->
	<input type="hidden" name="num" value="<%=num %>">
		<table class="table table-bordered" style="width: 400px;">
			<tr>
				<th>이름</th>
				<td>
				<input type="text" name="name" style="width: 150px;" value="<%=dto.getName() %>">
				</td>
			</tr>
			...
			<tr>
				<th>주소</th>
				<td>
				<input type="text" name="addr" style="width:250px;" value="<%=dto.getAddr() %>">
				</td>
			</tr>
