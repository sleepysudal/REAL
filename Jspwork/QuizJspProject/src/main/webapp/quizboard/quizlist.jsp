...
<body>
	<div style="margin:30px; 30px; width:800px;">
		...
		onclick="location.href='quizimagelist.jsp'"><i class="bi bi-piggy-bank"></i>이미지리스트<i class="bi bi-piggy-bank"></i></button>
	...
	<li class="page-item"><a class="page-link" href="quizlist.jsp?currentPage=<%=currentPage-1%>"><</a></li>
	<%}
	...
	if(startPage>1)
	{%>
		<li class="page-item"><a class="page-link" href="quizlist.jsp?currentPage=<%=startPage-perBlock%>"><<</a></li>
	 ...
	 { 
		 ...
		 {%>
			 ...
			 <li class="page-item active">
			 	<a style="background-color: skyblue; border: 1px solid skyblue;"
			 	class="page-link" href="quizlist.jsp?currentPage=<%=pp%>"><%=pp %></a>
			 </li>
		 <%}else
		 {%>
			<li>
	...
	if(1<=currentPage && currentPage<totalPage){
		%>
		<li class="page-item">
		<a class="page-link" href="quizlist.jsp?currentPage=<%=currentPage+1%>">></a>
		</li>
		<%
	}
	if(endPage<totalPage)
